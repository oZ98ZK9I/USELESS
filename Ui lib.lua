...
function Library:create(options)
    ...
    creditsTab:credit{Name = "Avrwm", Description = "Developer", Discord = "therealavrwm", V3rmillion = "N/A"}
    creditsTab:credit{Name = "Anto, xxwinterzz, Drew - 911wasmid", Description = "Contributors", Discord = "In the ui", V3rmillion = "N/A"}
    creditsTab:credit{Name = "Drew - 911wasmid", Description = "Testers / Lead help", Discord = "In the ui", V3rmillion = "N/A"}
	return mt
end
